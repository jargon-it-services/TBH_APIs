        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountCode = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: false),
                    AccountName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    AccountType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Mode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    IsUnderTrial = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2(7)", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    IsPlanActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    LastUpdated = table.Column<DateTime>(type: "datetime2(7)", nullable: true),
                    PlanAppliedTo = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                    Type = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2(7)", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    IsTransactionTypeActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    LastUpdated = table.Column<DateTime>(type: "datetime2(7)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FirmId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                    ...
                    FirmGstin = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    FirmContact = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    FirmEmail = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    FirmPhoto = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    FirmOwnerName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    FirmType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    FirmRegistration = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    FirmLogo = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2(7)", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    LastUpdated = table.Column<DateTime>(type: "datetime2(7)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PartnerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserMobile = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    UserPasswordHash = table.Column<byte[]>(type: "varbinary(64)", maxLength: 64, nullable: false),
                    ...
                    WorkerPaymentType = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2(7)", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    SubscriptionAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    DiscountedAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    SubscriptionAmountAfterDiscount = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExpensesTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                    AccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExpensesTypeName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2(7)", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    LastUpdated = table.Column<DateTime>(type: "datetime2(7)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServicePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    ServiceTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FirmId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsIncentiveApplicable = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IncentiveAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IncentivePercentage = table.Column<decimal>(type: "decimal(5,2)", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2(7)", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    LastUpdated = table.Column<DateTime>(type: "datetime2(7)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionRuleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FirmDetailsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessTokenJti = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionDetailsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                    TransactionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TransactionTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExpensesTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ServiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IncentiveAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TransactionRuleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FirmId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2(7)", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
            ...
            ExecuteStoredProcedureScripts(migrationBuilder);
        }

        private void ExecuteStoredProcedureScripts(MigrationBuilder migrationBuilder)
        {
            var baseDirectory = AppDomain.CurrentDomain.BaseDirectory;
            var scriptsPath = Path.Combine(baseDirectory, "..", "..", "..", "..", "TheBeautyHubData", "Scripts");
            
            // If running from API project, adjust path
            if (!Directory.Exists(scriptsPath))
            {
                scriptsPath = Path.Combine(baseDirectory, "..", "..", "..", "TheBeautyHubData", "Scripts");
            }

            var scriptFiles = new[]
            {
                "AccountStoredProcedures.sql",
                "UserStoredProcedures.sql",
                "FirmStoredProcedures.sql",
                "FirmDetailsStoredProcedures.sql",
                "PlansStoredProcedures.sql",
                "SubscriptionStoredProcedures.sql",
                "WalletStoredProcedures.sql",
                "ExpensesTypeStoredProcedures.sql",
                "ServicesStoredProcedures.sql",
                "TransactionTypeStoredProcedures.sql",
                "TransactionRulesStoredProcedures.sql",
                "TransactionStoredProcedures.sql",
                "TransactionDetailStoredProcedures.sql",
                "ReportStoredProcedures.sql",
                "ReportForAccountStoredProcedures.sql",
                "PartnerStoredProcedures.sql",
                "UserSessionStoredProcedures.sql",
                "ExceptionLogStoredProcedures.sql"
            };
